  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path={AppRouteProps.Player} element={<PlayerPage films={cardMocksArray}/>} />
        <Route path={AppRouteProps.Film} element={<MoviePage films={cardMocksArray} />} />
        <Route path={AppRouteProps.AddReview} element={<AddReviewPage films={cardMocksArray}/>} />
        <Route
